...
6. Run `asl-validate-project --root . --platform all` before live device proof. It checks the scaffolded helper, package-script snippets, scenarios, runners, and planner compatibility, and it reports placeholder app identity fields as warnings.
