...
function main(): void {
  ...
  try {
    ...
    fs.writeFileSync(esmEvidenceIdentityPath, [
      ...
      "assert.equal(validatedEvidenceResultAdmission.resultId, 'validator-result');",
