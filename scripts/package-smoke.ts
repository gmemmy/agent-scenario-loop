...
function main(): void {
  ...
  try {
    ...
    const resolveSmokeScript = [
      ...
      "assert.deepEqual(asl.DRIVER_PORT, ['tap', 'longPress', 'typeText', 'fill', 'scroll', 'swipe', 'pinch', 'rotate', 'pressButton', 'focus', 'assertVisible', 'inspectTree', 'screenshot', 'record', 'readLogs', 'collectPerfSignals']);",
      ...
      "assert.deepEqual(driverValidation.missingMethods, ['longPress', 'typeText', 'fill', 'scroll', 'swipe', 'pinch', 'rotate', 'pressButton', 'focus', 'assertVisible', 'inspectTree', 'record', 'readLogs', 'collectPerfSignals']);",
      "assert.equal(driverValidation.message, 'driver is missing required method(s): longPress, typeText, fill, scroll, swipe, pinch, rotate, pressButton, focus, assertVisible, inspectTree, record, readLogs, collectPerfSignals');",
