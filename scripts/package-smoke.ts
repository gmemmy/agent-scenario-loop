...
function main(): void {
  ...
  try {
    ...
    const resolveSmokeScript = [
      ...
      "assert.equal(profileSessionHelperIdentity.version, '1.1.0');",
      "assert.equal(profileSessionHelperIdentity.payloadId, 'agent-scenario-loop/profile-session-helper@1.1.0+setup-unscoped-milestones');",
      "assert.equal(profileSessionHelperIdentity.payloadSha256, 'b7421a84e8e39346702af2e7017a99ba492ced00de47446780e42a93146db275');",
      ...
      "assert.equal(/PROFILE_SESSION_HELPER_VERSION\\s*=\\s*['\"]1\\.1\\.0['\"]/u.test(profileSessionRuntime), false);",
      "assert.equal(/PROFILE_SESSION_HELPER_PAYLOAD_ID\\s*=\\s*['\"]agent-scenario-loop\\/profile-session-helper@1\\.1\\.0\\+setup-unscoped-milestones['\"]/u.test(profileSessionRuntime), false);",
      "assert.equal(/PROFILE_SESSION_HELPER_PAYLOAD_SHA256\\s*=\\s*['\"]b7421a84e8e39346702af2e7017a99ba492ced00de47446780e42a93146db275['\"]/u.test(profileSessionRuntime), false);",
      ...
      "assert.match(profileSessionDeclarations, /PROFILE_SESSION_HELPER_VERSION: ['\"]1\\.1\\.0['\"]/u);",
      "assert.match(profileSessionDeclarations, /PROFILE_SESSION_HELPER_PAYLOAD_ID: ['\"]agent-scenario-loop\\/profile-session-helper@1\\.1\\.0\\+setup-unscoped-milestones['\"]/u);",
      "assert.match(profileSessionDeclarations, /PROFILE_SESSION_HELPER_PAYLOAD_SHA256: ['\"]b7421a84e8e39346702af2e7017a99ba492ced00de47446780e42a93146db275['\"]/u);",
