...
function main(): void {
  ...
  try {
    ...
    const typeSmokeSource = [
      ...
      "void validatedEvidenceReportIdentityInspection; void validatedEvidenceAdmissionResult; void validatedEvidenceReportIdentityVersion; void validatedEvidenceAdmissionVersion;",
