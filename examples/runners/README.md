...
- Rich scenario actions such as `longPress`, `swipe`, `drag`, `pinch`, `rotate`, `typeText`, `pressKey`, `pressButton`, `customGesture`, and `runSequence` are valid vocabulary but not automatically supported by these fixtures.
