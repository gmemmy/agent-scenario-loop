...
| `agent-scenario-loop/runner/live-proof` | aggregate live-proof artifact validation, multi-artifact platform-set checks, formatting, failed-proof gating, and regression gating |
