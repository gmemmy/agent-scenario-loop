...
| Subpath | Purpose |
| --- | --- |
| `agent-scenario-loop/runner/android-adb` | Android adb readiness, launch, profile-session control, and logcat capture |
| `agent-scenario-loop/runner/android-adb-driver` | adb-backed `readLogs` driver adapter |
